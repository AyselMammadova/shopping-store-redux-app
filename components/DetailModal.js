...
const DetailModal = ({selectedItem, cartItemm, sizes, handleAddToCart, handleDecreaseCart, selectedOption, handleChange, bell, handleBell, fav, handleFav}) => {
    ...
    return (
        <div className="fixed inset-0 bg-llblack backdrop-blur-sm flex items-center justify-center z-20 overflow-hidden">
            <div className="absolute top-[147px] left-[50%] -translate-x-2/4 w-[90%] sm:w-[70%] 2xl:w-[64%]">
                <div className="modal-content overflow-scroll">
                    {selectedItem && 
                        <div key={selectedItem.id} className="detail-wrapper bg-white rounded-[8px] px-[15px] sm:px-[44px] py-[15px] sm:pt-[44px] sm:pb-[48px] shadow-shadow11">
