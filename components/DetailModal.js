...
const DetailModal = ({selectedItem, cartItemm, sizes, handleAddToCart, handleDecreaseCart, selectedOption, handleChange, bell, handleBell, fav, handleFav, toggleModal, modalRef}) => {
    ...
    return (
        <Fragment>
            <div className="fixed inset-0 bg-llblack backdrop-blur-sm flex h-[100vh] items-center justify-center z-20 overflow-y-auto">
                <div className="absolute top-[147px] left-[50%] -translate-x-2/4 w-[90%] sm:w-[70%] 2xl:w-[64%]"
                ref={modalRef}>
                            ...
                            <div key={selectedItem.id} className="detail-wrapper bg-white rounded-[8px] px-[15px] sm:px-[44px] pt-[30px] sm:pt-[44px] pb-[15px] sm:pb-[48px] shadow-shadow11">
                                <div className="detail-wrap grid grid-cols-5 h-[100%] gap-8">
                                    ...
                                    <div className="product-info-wrap col-span-5 xl:col-span-3 grid">
                                        <div className="rounded-[4px] border border-solid border-grey7 col-span-5 grid grid-cols-5 gap-4 p-[20px]">
                                            <div className="product-info col-span-5 sm:col-span-3">
                                                ...
                                                <p className="my-[10px] text-xsm font-semibold">
                                                    ...
                                                    Koton
                                                    <span className="ml-[6px] relative top-[4px]">
                                            ...
                                            <div className="border border-solid border-grey7 rounded-[4px] h-144px] py-[14px] px-[24px] flex flex-col items-center justify-center text-center col-span-3 sm:col-span-1">
                                                <Image src="/images/car.svg" alt="car" width="51px" height="51px" />
                                            ...
                                            <div className="border border-solid border-grey7 rounded-[4px] h-144px] py-[14px] px-[24px] flex flex-col items-center justify-center text-center col-span-2 sm:col-span-1">
                                                <Image src="/images/ticket.svg" alt="ticket" width="51px" height="51px" />
                                        ...
                                        <div className="colors-wrap col-span-5 my-[20px] border border-solid border-grey7 rounded-[4px] px-[20px] pt-[14px] pb-[20px] h-[126px]">
                                        ...
                                        <div className="col-span-5 grid grid-cols-7 gap-4 items-end border border-solid border-grey7 rounded-[4px] px-[20px] py-[14px]">
                                            <div className="col-span-7 2xl:col-span-5 grid ssm:grid-cols-2 gap-4">
                                                ...
                                                <div className="right-side">
                                                    <div className="count-sec">
                                                        ...
                                                        <div className="count-body mt-[18px]">
                                                            <div className="cart-item-quantity w-[100%] inline-flex rounded-[6px] h-[40px] border border-solid border-grey7">
                                                                <button
                                                                    className="text-xl text-grey8 w-[40px] flex items-center justify-center"
                                                                ...
                                                                <div className="count w-calc80 border-l border-l-solid border-l-grey7 border-r border-r-solid border-r-grey7 bg-lwhite6 flex items-center justify-center px-[15px] text-sm">
                                                                    {cartItemm.cartQuantity !== undefined ? 
                                            ...
                                            <div className="col-span-7 2xl:col-span-2 grid grid-cols-2 gap-4">
                                                <div>
                                                    <div className="border border-solid border-grey8 rounded-[6px] h-[40px] flex flex-col items-center justify-center text-center cursor-pointer"
                                                    onClick={handleBell}>
                                        ...
                                        <div className="col-span-5 grid grid-cols-7 gap-4 mt-[16px]">
                                            <div className="col-span-7 2xl:col-span-5 grid ssm:grid-cols-2 gap-4">
                                                <button className="rounded-[100px] shadow-shadow9 bg-green text-white w-[100%] h-[40px] flex items-center justify-center font-semibold text-base">
                                                    HEMEN AL
                                                </button>
                                                
                                                <button className="rounded-[100px] shadow-shadow10 bg-red text-white w-[100%] h-[40px] flex items-center justify-center font-semibold text-base"
                                                onClick={() => handleAddToCart(selectedItem)}>
                                                    SEBETE EKLE
                                                </button>
                                            </div>
