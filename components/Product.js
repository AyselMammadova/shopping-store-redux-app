    ...
    return (
        <>
            ...
            >
                ...
                {posts.map((post) => (
                    <div key={post.id} className="product-item rounded-[8px] bg-white shadow-shadow5 hover:shadow-shadow7 overflow-hidden cursor-pointer transition ease-in duration-150"
                    ...
                    onMouseLeave={handleMouseLeave}>
                        <div className="img-wrap h-[420px] relative">
                            ...
                            <div className={`${isHover[post.id] ? 'opacity-1' : 'opacity-0'} bigger-wrap transition ease-in duration-150 absolute top-[50%] left-[50%] -translate-x-2/4 -translate-y-2/4 z-10`}>
                                <img src="/images/bigger.svg" alt="bigger" />
                            </div>

                            <div className={`${isHover[post.id] ? 'opacity-1' : 'opacity-0'} sizes-wrapper transition ease-in duration-150 absolute left-[20px] right-[20px] bottom-[60px] z-10 rounded-[4px] bg-lwhite5 flex justify-between items-center h-[40px] px-[18px]`}>
                        ...
                        <div className="info-wrap py-[13px] px-[25px]">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <button className={`${isHover[post.id] ? 'opacity-1' : 'opacity-0'} transition ease-in duration-150 rounded-[100px] bg-red text-white shadow-shadow1 px-[10px] py-[5px] text-sm font-semibold`}>
                                    Sepete ekle
                                </button>
                            </div>
                        </div>
