...
export const SubsMenu = () => {
  ...
  return (
    <>
        <div className="subCategories w-[maxContent] 2md:w-[100%] px-[36px] xxl:px-[84px]">
            ...
            <div className="grid grid-cols-5 gap-4 mt-[38px] xl:max-h-[700px] max-h-[960px] overflow-y-scroll">
                <div className="col-span-5 2md:col-span-3">
